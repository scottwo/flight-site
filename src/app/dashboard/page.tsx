    ...
    <main className="min-h-screen bg-[#eaf1f8] text-[#0b1f33]">
      <div className="mx-auto flex max-w-5xl flex-col gap-8 px-6 py-12">
        <header className="space-y-3">
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-[#5d7995]">Dashboard</p>
          <h1 className="text-4xl font-semibold text-[#0b1f33]">Welcome, {displayName}</h1>
          <p className="text-[#35506c]">Manage your pilot profile and public page.</p>
        </header>

        <section className="grid gap-6 md:grid-cols-2">
          <div className="rounded-3xl border border-[#d4e0ec] bg-white p-6 shadow-sm">
            <h2 className="text-lg font-semibold text-[#0b1f33]">Public page</h2>
            {handle ? (
              <p className="mt-2 text-sm text-[#35506c]">
                Your public page:{" "}
                <Link href={`/p/${handle}`} className="font-semibold text-[#1f4b71] hover:underline">
                  /p/{handle}
                </Link>
              </p>
            ) : (
          ...
          <div className="rounded-3xl border border-[#d4e0ec] bg-white p-6 shadow-sm">
            <h2 className="text-lg font-semibold text-[#0b1f33]">Next steps</h2>
